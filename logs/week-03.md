...
-  Develop initial poster sections connecting SHAP analysis, quantum encoding of TNBC datasets, and their relationship to the A-QLSTM-A model.
-  Create a brief slideshow about hybrid quantum models
...
During our weekly meeting, I took notes on feedback and future revisions, and then redesigned the poster using a new template better suited to an academic research presentation.

I also created a brief slideshow on hybrid quantum models and how quantum encoding supports them. 
